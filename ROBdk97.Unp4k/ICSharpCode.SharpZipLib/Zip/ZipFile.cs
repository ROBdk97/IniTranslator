using ROBdk97.Unp4k.ICSharpCode.SharpZipLib.Checksum;
using ROBdk97.Unp4k.ICSharpCode.SharpZipLib.Core;
using ROBdk97.Unp4k.ICSharpCode.SharpZipLib.Encryption;
using ROBdk97.Unp4k.ICSharpCode.SharpZipLib.Zip;
using ROBdk97.Unp4k.ICSharpCode.SharpZipLib.Zip.Compression;
using ROBdk97.Unp4k.ICSharpCode.SharpZipLib.Zip.Compression.Streams;
using System;
        ...
        public Stream GetInputStream(long entryIndex)
        {
            ...
            switch (method)
            {
                ...
                case CompressionMethod.ZStd:
                    // Read the compressed stream into a byte array
                    byte[] compressedData = ReadAllBytes(result);

                    // Decompress using ZstdNet's Decompressor
    ...
    string.Format("Exception during test - '{0}'", ex.Message));
		...
		*/
        ...
        int WriteCentralDirectoryHeader(ZipEntry entry)
        {
            ...
            byte[] rawComment = (entry.Comment != null) ? Encoding.ASCII.GetBytes(entry.Comment) : [];
